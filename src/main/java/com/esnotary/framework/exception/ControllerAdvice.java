package com.esnotary.framework.exception;

import com.esnotary.framework.result.APIConstant;
import com.esnotary.framework.result.APIResult;
import com.esnotary.framework.result.APIResultUtil;
import com.esnotary.framework.util.RequestUtil;
...
public class ControllerAdvice {
    ...
    @ExceptionHandler
    public APIResult validationExceptionHandler(BindException exception){
        String message = exception.getAllErrors().get(0).getDefaultMessage();
        return APIResultUtil.responseBusinessFailedResult(APIConstant.BUSINESS_PARAMETER_ERROR,message);
    }
